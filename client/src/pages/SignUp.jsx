      ...
      <div className="w-full max-w-md rounded-2xl border border-zinc-900 bg-zinc-900/30 p-8 backdrop-blur-md shadow-2xl">
        <div className="mb-8 text-center">
          <Link to="/" className="inline-flex items-center gap-2 mb-3 hover:opacity-90 transition-opacity">
            <Logo className="h-8 w-8" gradientId="logo-grad-signup" />
          ...
          <h2 className="text-2xl font-bold text-zinc-100">Get Started</h2>
          <p className="text-zinc-400 text-sm mt-1.5">Create your intelligent learning companion account</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-zinc-400">
          ...
          <Link to="/sign-in" className="text-indigo-400 hover:text-indigo-300 transition-colors font-medium">
            Sign in
          </Link>
        </p>
      </div>
