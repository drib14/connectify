      ...
      <header className="sticky top-0 z-50 w-full border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-90 transition-opacity">
            <Logo className="h-6 w-6" gradientId="logo-grad-home" />
          ...
          <div className="flex items-center gap-4">
            {loading ? (
              <div className="h-9 w-9 rounded-full bg-zinc-900 border border-zinc-800 animate-pulse" />
            ) : !user ? (
              <>
                <Link
                  to="/sign-in"
                  className="cursor-pointer text-sm font-semibold text-zinc-300 hover:text-white transition-colors px-4 py-2"
                >
                  Sign In
                </Link>
                <Link
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Minimalist Profile Indicator / Logout button */}
                <div className="flex items-center gap-2 pl-2 border-l border-zinc-800">
                  {user.avatar ? (
                    ...
                    <div className="h-8 w-8 rounded-full bg-indigo-600/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400">
                  ...
                  <button
                    onClick={logout}
                    title="Sign Out"
                    className="cursor-pointer h-8 w-8 rounded-full bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-zinc-100 transition-all"
                  >
      ...
      <main className="flex-1">
        <section className="relative px-6 pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.15] mb-6 text-zinc-50">
              Study{" "}
        ...
        <section id="features" className="px-6 py-20 bg-zinc-950/50 border-t border-zinc-900 relative">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4 text-zinc-50">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group rounded-2xl border border-zinc-900 bg-zinc-900/20 p-6 hover:border-indigo-500/30 hover:bg-zinc-900/40 transition-all duration-300">
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-indigo-300 transition-colors text-zinc-100">Tutor AI Gateway</h3>
              ...
              <div className="group rounded-2xl border border-zinc-900 bg-zinc-900/20 p-6 hover:border-violet-500/30 hover:bg-zinc-900/40 transition-all duration-300">
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-violet-300 transition-colors text-zinc-100">Quiz AI Generator</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
              ...
              <div className="group rounded-2xl border border-zinc-900 bg-zinc-900/20 p-6 hover:border-indigo-500/30 hover:bg-zinc-900/40 transition-all duration-300">
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-indigo-300 transition-colors text-zinc-100">Study Planner AI</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
              ...
              <div className="group rounded-2xl border border-zinc-900 bg-zinc-900/20 p-6 hover:border-violet-500/30 hover:bg-zinc-900/40 transition-all duration-300">
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-violet-300 transition-colors text-zinc-100">Weakness Analyzer</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
        ...
        <section id="tutors" className="px-6 py-20 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 text-zinc-50">
            ...
            <div className="relative rounded-2xl border border-zinc-900 bg-zinc-900/10 p-2 overflow-hidden aspect-[4/3] flex items-center justify-center">
              ...
              <div className="relative z-10 w-full max-w-sm rounded-xl border border-zinc-800 bg-zinc-950 p-6 shadow-2xl">
                ...
                <p className="text-zinc-300 text-xs leading-relaxed mb-3 bg-zinc-900/50 p-3 rounded-lg border border-zinc-900">
                  "Based on your last quiz, you are struggling with <strong>Asynchronous JavaScript loops</strong>. Let's review how the event loop manages promises inside <code>for...of</code> statements."
                </p>
      ...
      <footer id="about" className="border-t border-zinc-900 bg-zinc-950 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <Logo className="h-5 w-5" gradientId="logo-grad-foot" />
